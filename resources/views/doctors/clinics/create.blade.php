<x-dashboard-layout>
    ...
    <x-settings heading="Clinic's Register">
        ...
        <form action="/dashboard/clinics" method="POST" class="mt-10" enctype="multipart/form-data">
            @csrf
            <x-form.input name="name" required/>
            <input name="lat" type="text" id="lat" required hidden>
            <input name="lng" type="text" id="lng" required hidden>

            <h4 class="text-center font-bold text-xl mb-2">Pin your clinic's position on the map!</h4>
            <div id="map"></div>
            <div class="mb-6 mt-6">
                <button type="submit"
