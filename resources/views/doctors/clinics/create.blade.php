<x-dashboard-layout>
    ...
    <div class="headerTitle ">
        <h1 class="text-2xl mb-3 font-bold">Clinic Registration</h1>
        <ul class="pl-14 pageIndex flex gap-2">
            ...
            <li class="active">
                <a href="{{route('clinics-register')}}">Register Your Clinic</a>
            </li>
        </ul>
    </div>
                    ...
                    <div class="flex flex-col">
                        <div class="-my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
                            <div class="py-2 align-middle inline-block min-w-full sm:px-6 lg:px-8">
                                ...
                                <form action="/dashboard/clinics" method="POST" class="mt-10"
                                    ...
                                    <h4 class="text-center font-bold text-xl mb-2">Pin your Clinic's position on the
                                        map!</h4>
